    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-950 to-black p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-red-200 text-xs sm:text-sm">Questions? 147 (YAY) Damon on Discord: <a href="https://discord.com/users/399252368190865411" className="text-red-400 hover:text-red-300 underline">entj.</a></p>
        </div>
